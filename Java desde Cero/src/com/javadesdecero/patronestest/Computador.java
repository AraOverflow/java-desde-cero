...
public class Computador implements ICompClonador {
	...
	public Computador(String procesador, String grafica, double ghz, String placaBase, boolean lectorTarjetas,
	...
	public Computador(String procesador, String grafica) {
		super();
		this.procesador = procesador;
		this.grafica = grafica;
	}
	...
	public Computador clonar() {
		
		Computador computador = null;
		
		try {
			computador = (Computador)this.clone();
